...
procedure AppendAndCustom(var vSql: string; const vCustStr: string; vAndOr: string = 'and'; vCondition: Boolean = True);
...
function ForDelete(Table: string): string; overload;
//function ForCreate(Table: string; Fields: array of string; Keys: array of string): string; overload;
...
procedure AppendAndCustom(var vSql: string; const vCustStr: string; vAndOr: string; vCondition: Boolean);
begin
...
var
  i: Integer;
begin
  Result := 'delete from ' + DBName(Table);
...
function ForDelete(Table: string): string;
begin
  Result := ForDelete(Table, []);
end;

function ForCreate(Table: string): string; overload;
begin
  //TODO
end;
